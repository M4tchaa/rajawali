                ...
                <?php foreach ($barangs as $row): ?>
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><?= htmlspecialchars($row['namaBarang'], ENT_QUOTES, 'UTF-8') ?></h5>
                                <p class="card-text">Stock: <?= htmlspecialchars($row['stock'], ENT_QUOTES, 'UTF-8') ?></p>
                                <p class="card-text">Harga Online: Rp<?= number_format($row['hargaOnline'], 0, ',', '.') ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
